...
export default function Overview() {
    ...
    const filterGoalkeepers =
        ranking && ranking.filter((player) => player.position == "Goalkeeper");
    const filterDefenders =
        ranking && ranking.filter((player) => player.position == "Defender");
    const filterMidfielders =
        ranking && ranking.filter((player) => player.position == "Midfielder");
    const filterAttackers =
        ranking && ranking.filter((player) => player.position == "Attacker");
